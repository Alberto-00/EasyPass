...
<nav class="coll-1 gridd-y">
    ...
    <a class="btnn" href="${pageContext.request.contextPath}/direttoreServlet/GestioneReport">Gestione Report</a>
    <a class="btnn" href="${pageContext.request.contextPath}/direttoreServlet/GestioneFormato">Gestione Formato</a>
